...
viennagrid_error viennagrid_minus(viennagrid_dimension dimension,
                                  viennagrid_numeric const * v1,
                                  viennagrid_numeric const * v2,
                                  viennagrid_numeric       * result)
{
                                                 ...
                                                 viennagrid_numeric * coords)
{
  ...
  if (coords)
  {
    for (viennagrid_dimension i = 0; i != dim; ++i)
      coords[+i] = 0;
    ...
    switch (element_type)
    {
      ...
      case VIENNAGRID_ELEMENT_TYPE_TRIANGLE:
      {
        ...
        else if (dim == 3)
        {
          ...
          viennagrid_minus(3, A, B, AmB);
          viennagrid_minus(3, A, C, AmC);
          viennagrid_minus(3, B, A, BmA);
          viennagrid_minus(3, B, C, BmC);
          viennagrid_minus(3, C, A, CmA);
          viennagrid_minus(3, C, B, CmB);
...
//             PointT circ_cent = A * (alpha/denominator) + B * (beta/denominator) + C * (gamma/denominator);
      ...
      case VIENNAGRID_ELEMENT_TYPE_TETRAHEDRON:
      {
        ...
        viennagrid_minus(3, point_coords[1], O, A);

        viennagrid_numeric B[3];
        viennagrid_minus(3, point_coords[2], O, A);

        viennagrid_numeric C[3];
        viennagrid_minus(3, point_coords[3], O, A);
