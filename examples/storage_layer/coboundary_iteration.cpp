...
int main()
{
    ...
    typedef viennagrid::config::result_of::full_topology_config<viennagrid::triangle_tag, handle_tag>::type topology_config;

    
    std::cout << typeid(topology_config).name() << std::endl;
...
//     typedef viennagrid::result_of::topology<topology_config>::type domain_type;
