...
int main()
{
    ...
    typedef viennagrid::storage::result_of::continuous_id_generator_config<config, viennagrid::storage::smart_id_tag<int> >::type id_generator_config;
...
//     cout << typeid( viennagrid::storage::result_of::container_of<collection_type, char>::type ).name() << endl;
    ...
    viennagrid::storage::container_collection::handle_if(view_collection, view_collection2, view2_predicate());
