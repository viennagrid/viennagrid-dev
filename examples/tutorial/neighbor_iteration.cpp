...
int main()
{
...

  {
    ...
    ConstNeighborRangeType const_neighbor_range = ConstNeighborRangeType(cmesh, th1); //viennagrid::neighbor_elements<viennagrid::triangle_tag, viennagrid::vertex_tag>(cmesh, th1);
