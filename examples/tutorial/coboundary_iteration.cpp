...
int main()
{
    ...
    typedef viennagrid::result_of::coboundary_range<DomainType, viennagrid::vertex_tag, viennagrid::triangle_tag>::type coboundary_range_type;
    ...
    typedef viennagrid::result_of::const_coboundary_range<DomainType, viennagrid::vertex_tag, viennagrid::triangle_tag>::type const_coboundary_range_type;
