...
namespace viennagrid
{
  ...
  struct unpack_element_functor
  {
    ...
    unpack_element_functor(element_tag_t element_tag_in, mesh_hierarchy_type mesh_hierarchy_in) : element_tag_(element_tag_in), mesh_hierarchy_(mesh_hierarchy_in) {}
  ...
  public:
    ...
    base_element_range_t() : mesh_hierarchy_(0), element_index_begin(0), element_index_end(0) {}
    base_element_range_t(ViewFunctorT view_functor_) : mesh_hierarchy_(0), element_index_begin(0), element_index_end(0), view_functor(view_functor_) {}


    template<bool mesh_is_const>
    void from_mesh(base_mesh_t<mesh_is_const> mesh, element_tag_t element_tag_in);

    template<bool element_is_const>
    void boundary_from_element(base_element_t<element_is_const> element, element_tag_t element_tag_in);

    template<bool mesh_is_const, bool element_is_const>
    void coboundary_from_element(base_mesh_t<mesh_is_const> mesh, base_element_t<element_is_const> element, element_tag_t coboundary_tag_in);
...
//     size_type size() const { return element_index_end-element_index_begin; }
    ...
    element_tag_t tag() const { return element_tag_; }
  ...
  template<bool mesh_is_const>
  void base_element_range_t<ViewFunctorT, range_is_const>::from_mesh(base_mesh_t<mesh_is_const> mesh, element_tag_t element_tag_in)
  {
    element_tag_ = element_tag_in;
    mesh_hierarchy_ = mesh.mesh_hierarchy();

    viennagrid_elements_get_const(mesh.internal_mesh(),
  ...
  template<>
  template<>
  void base_element_range_t<true_functor, false>::from_mesh(base_mesh_t<false> mesh, element_tag_t element_tag_in)
  {
    element_tag_ = element_tag_in;
    mesh_hierarchy_ = mesh.mesh_hierarchy();
  ...
  template<typename ViewFunctorT, bool range_is_const>
  template<bool element_is_const>
  void base_element_range_t<ViewFunctorT, range_is_const>::boundary_from_element(base_element_t<element_is_const> element, element_tag_t element_tag_in)
  {
    element_tag_ = element_tag_in;
    mesh_hierarchy_ = element.mesh_hierarchy();

    viennagrid_element_boundary_elements_const(mesh_hierarchy().internal_mesh_hierarchy(),
  ...
  template<>
  template<>
  void base_element_range_t<true_functor, false>::boundary_from_element(base_element_t<false> element, element_tag_t element_tag_in)
  {
    element_tag_ = element_tag_in;
    mesh_hierarchy_ = element.mesh_hierarchy();
  ...
  template<typename ViewFunctorT, bool range_is_const>
  template<bool mesh_is_const, bool element_is_const>
  void base_element_range_t<ViewFunctorT, range_is_const>::coboundary_from_element(base_mesh_t<mesh_is_const> mesh, base_element_t<element_is_const> element, element_tag_t coboundary_tag_in)
  {
    element_tag_ = coboundary_tag_in;
    mesh_hierarchy_ = element.mesh_hierarchy();

    viennagrid_element_coboundary_elements_const(mesh.internal_mesh(),
                                                 element.tag().internal_element_tag(),
                                                 element.id(),
                                                 tag().internal_element_tag(),
                                                 &element_index_begin,
  ...
  template<>
  template<>
  void base_element_range_t<true_functor, false>::coboundary_from_element(base_mesh_t<false> mesh, base_element_t<false> element, element_tag_t coboundary_tag_in)
  {
    element_tag_ = coboundary_tag_in;
    mesh_hierarchy_ = element.mesh_hierarchy();
  ...
  template<bool is_const>
  class mesh_element_range_t : public base_element_range_t<true_functor, is_const>
  {
  public:
    typedef typename base_element_range_t<true_functor, is_const>::mesh_hierarchy_type mesh_hierarchy_type;
    typedef typename base_element_range_t<true_functor, is_const>::mesh_type mesh_type;
    typedef typename base_element_range_t<true_functor, is_const>::element_type element_type;

    mesh_element_range_t(mesh_type mesh, element_tag_t element_tag_)
  ...
  class static_mesh_element_range_t : public mesh_element_range_t<is_const>
  {
  public:

    typedef typename mesh_element_range_t<is_const>::mesh_hierarchy_type mesh_hierarchy_type;
    typedef typename mesh_element_range_t<is_const>::mesh_type mesh_type;
    typedef typename mesh_element_range_t<is_const>::element_type element_type;

    static_mesh_element_range_t(mesh_type mesh) : mesh_element_range_t<is_const>(mesh, ElementTagT()) {}
  ...
  template<bool is_const>
  class boundary_element_range_t : public base_element_range_t<true_functor, is_const>
  {
  public:
    typedef typename base_element_range_t<true_functor, is_const>::mesh_hierarchy_type mesh_hierarchy_type;
    typedef typename base_element_range_t<true_functor, is_const>::mesh_type mesh_type;
    ...
    boundary_element_range_t(element_type element, element_tag_t element_tag_)
  ...
  class static_boundary_element_range_t : public boundary_element_range_t<is_const>
  {
  public:

    typedef typename boundary_element_range_t<is_const>::mesh_hierarchy_type mesh_hierarchy_type;
    typedef typename boundary_element_range_t<is_const>::mesh_type mesh_type;
    typedef typename boundary_element_range_t<is_const>::element_type element_type;

    static_boundary_element_range_t(element_type element) : boundary_element_range_t<is_const>(element, BoundaryTagT()) {}
  ...
  template<bool is_const>
  class coboundary_element_range_t : public base_element_range_t<true_functor, is_const>
  {
  public:
    typedef typename base_element_range_t<true_functor, is_const>::mesh_hierarchy_type mesh_hierarchy_type;
    typedef typename base_element_range_t<true_functor, is_const>::mesh_type mesh_type;
    ...
    coboundary_element_range_t(mesh_type mesh, element_type element, element_tag_t coboundary_tag_)
    {
//       if (mesh.is_coboundary_obsolete(element.tag(), coboundary_tag_))
//       {
//         viennagrid_element_make_coboundary_elements( mesh.internal_mesh(), element.tag().internal_element_tag(), coboundary_tag_.internal_element_tag() );
//         mesh.set_coboundary_uptodate(element.tag(), coboundary_tag_);
//       }
  ...
  class static_coboundary_element_range_t : public coboundary_element_range_t<is_const>
  {
  public:

    typedef typename coboundary_element_range_t<is_const>::mesh_hierarchy_type mesh_hierarchy_type;
    typedef typename coboundary_element_range_t<is_const>::mesh_type mesh_type;
    typedef typename coboundary_element_range_t<is_const>::element_type element_type;

    static_coboundary_element_range_t(mesh_type & mesh, element_type element) : coboundary_element_range_t<is_const>(mesh, element, CoboundaryTagT()) {}
  ...
  struct region_view_functor
  {
    ...
    { return is_in_region(element, mesh_region); }
  ...
  template<bool is_const>
  class mesh_region_element_range_t : public base_element_range_t<region_view_functor, is_const>
  {
  public:
    typedef typename base_element_range_t<region_view_functor, is_const>::mesh_hierarchy_type mesh_hierarchy_type;
    typedef typename base_element_range_t<region_view_functor, is_const>::mesh_type mesh_type;
    typedef typename base_element_range_t<region_view_functor, is_const>::element_type element_type;

    typedef typename result_of::const_nonconst<mesh_region_t, is_const>::type mesh_region_type;

    mesh_region_element_range_t(mesh_region_type region, element_tag_t element_tag_) : base_element_range_t<region_view_functor, is_const>( region_view_functor(region) )
  ...
  template<typename ElementTagT, bool is_const>
  class static_mesh_region_element_range_t : public mesh_region_element_range_t<is_const>
  {
  public:

    typedef typename mesh_region_element_range_t<is_const>::mesh_hierarchy_type mesh_hierarchy_type;
    typedef typename mesh_region_element_range_t<is_const>::mesh_type mesh_type;
    typedef typename mesh_region_element_range_t<is_const>::element_type element_type;

    typedef typename result_of::const_nonconst<mesh_region_t, is_const>::type mesh_region_type;

    static_mesh_region_element_range_t(mesh_region_type region) : mesh_region_element_range_t<is_const>(region, ElementTagT()) {}
  ...
  namespace result_of
  {
    ...
    {
      typedef mesh_element_range_t<false> type;
    };

    template<typename ElementTagT>
    struct element_range<mesh_t, ElementTagT>
    {
      typedef static_mesh_element_range_t<ElementTagT, false> type;
    };
    ...
    {
      typedef mesh_element_range_t<true> type;
    };

    template<typename ElementTagT>
    struct const_element_range<mesh_t, ElementTagT>
    {
      typedef static_mesh_element_range_t<ElementTagT, true> type;
    };
    ...
    template<bool is_const>
    struct const_element_range<base_element_t<is_const>, null_type>
    {
      typedef boundary_element_range_t<true> type;
    };

    template<typename ElementTagT, bool is_const>
    struct const_element_range<base_element_t<is_const>, ElementTagT>
    {
      typedef static_boundary_element_range_t<ElementTagT, true> type;
    };
    ...
    {
      typedef boundary_element_range_t<false> type;
    };

    template<typename ElementTagT>
    struct element_range<element_t, ElementTagT>
    {
      typedef static_boundary_element_range_t<ElementTagT, false> type;
    };
    ...
    template<bool is_const>
    struct const_element_range<base_mesh_region_t<is_const>, null_type>
    {
      typedef mesh_region_element_range_t<true> type;
    };

    template<typename ElementTagT, bool is_const>
    struct const_element_range<base_mesh_region_t<is_const>, ElementTagT>
    {
      typedef static_mesh_region_element_range_t<ElementTagT, true> type;
    };
    ...
    {
      typedef mesh_region_element_range_t<false> type;
    };

    template<typename ElementTagT>
    struct element_range<mesh_region_t, ElementTagT>
    {
      typedef static_mesh_region_element_range_t<ElementTagT, false> type;
    };
    ...
    template<typename ElementTagT>
    struct coboundary_range<element_t, ElementTagT>
    {
      typedef static_coboundary_element_range_t<ElementTagT, false> type;
    };

    template<typename ElementTagT>
    struct const_coboundary_range<element_t, ElementTagT>
    {
      typedef static_coboundary_element_range_t<ElementTagT, true> type;
    };
  ...
  typename viennagrid::result_of::element_range<SomethingT>::type elements(SomethingT something, mesh_t::element_tag_type element_tag)
