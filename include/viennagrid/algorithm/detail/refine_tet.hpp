...
namespace viennagrid
{
  namespace detail
  {
     ...
     */
    template<typename MeshT, typename VertexT>
    bool stable_line_is_longer(MeshT const & mesh,
                               VertexT v1_1, VertexT v1_2,
                               VertexT v2_1, VertexT v2_2)
    {
...
//       const VertexType & v2_2 = viennagrid::dereference_handle( mesh, v2_2 );
      ...
      VertexT v1_1_ptr = (v1_1.id() < v1_2.id()) ? v1_1 : v1_2; //v1_1 carries smaller ID
      VertexT v1_2_ptr = (v1_1.id() < v1_2.id()) ? v1_2 : v1_1; //v1_2 carries larger ID

      VertexT v2_1_ptr = (v2_1.id() < v2_2.id()) ? v2_1 : v2_2; //v2_1 carries smaller ID
      VertexT v2_2_ptr = (v2_1.id() < v2_2.id()) ? v2_2 : v2_1; //v2_2 carries larger ID
    ...
    struct element_refinement<tetrahedron_tag>
    {
                         ...
                         EdgeRefinementFlagAccessor const &, EdgeToVertexHandleAccessor const &)
      {
        ...
        std::vector<VertexType> vertices( tetrahedron_tag().vertex_count() );
...
//         // Step 2: Add new cells to new mesh:
        add_refinement_element(elements_vertices, vertices, 0, 1, 2, 3);
      }
                         ...
                         EdgeRefinementFlagAccessor const & edge_refinement_flag_accessor, EdgeToVertexHandleAccessor const & edge_to_vertex_handle_accessor)
      {
        ...
        typedef typename viennagrid::result_of::const_line_range<ElementT>::type            EdgeOnCellRange;
        typedef typename viennagrid::result_of::iterator<EdgeOnCellRange>::type           EdgeOnCellIterator;

        typedef typename viennagrid::result_of::line<ElementT>::type             EdgeType;
        typedef typename viennagrid::result_of::vertex<MeshT>::type             VertexType;
        ...
        std::vector<VertexType> ordered_vertices( tetrahedron_tag().vertex_count()+1 );

        EdgeOnCellRange edges_on_cell(element_in);
        EdgeOnCellIterator eocit = edges_on_cell.begin();
        EdgeType e0 = *eocit; ++eocit;
        EdgeType e1 = *eocit; ++eocit;
        EdgeType e2 = *eocit; ++eocit;
        EdgeType e3 = *eocit; ++eocit;
                         ...
                         EdgeRefinementFlagAccessor const & edge_refinement_flag_accessor, EdgeToVertexHandleAccessor const & edge_to_vertex_handle_accessor)
      {
        ...
        typedef typename viennagrid::result_of::vertex<ElementType>::type             VertexType;
        typedef typename viennagrid::result_of::line<ElementType>::type             EdgeType;
...
//         static_array< VertexHandleType, boundary_elements<tetrahedron_tag, vertex_tag>::num > vertices;
        ...
        std::vector<VertexType> ordered_vertices( tetrahedron_tag().vertex_count()+2 );
                         ...
                         EdgeRefinementFlagAccessor const & edge_refinement_flag_accessor, EdgeToVertexHandleAccessor const & edge_to_vertex_handle_accessor)
      {
        ...
        typedef typename viennagrid::result_of::vertex<ElementType>::type             VertexType;
        typedef typename viennagrid::result_of::element<ElementType>::type             EdgeType;
        ...
        //
        std::vector<VertexType> ordered_vertices( tetrahedron_tag().vertex_count()+3 );
                         ...
                         EdgeRefinementFlagAccessor const & edge_refinement_flag_accessor, EdgeToVertexHandleAccessor const & edge_to_vertex_handle_accessor)
      {
        ...
        // Step 2: Bring vertices in correct order, such that refined edge is on {0,1}-edge
        //
        std::vector<VertexType> ordered_vertices( tetrahedron_tag().vertex_count()+4 );
                         ...
                         EdgeRefinementFlagAccessor const & edge_refinement_flag_accessor, EdgeToVertexHandleAccessor const & edge_to_vertex_handle_accessor)
      {
        ...
        // Step 2: Bring vertices in correct order, such that refined edge is on {0,1}-edge
        //
        std::vector<VertexType> ordered_vertices( tetrahedron_tag().vertex_count()+5 );
                         ...
                         EdgeRefinementFlagAccessor const &, EdgeToVertexHandleAccessor const & edge_to_vertex_handle_accessor)
      {
        ...
        const unsigned int num_vertices = tetrahedron_tag().vertex_count();
        const unsigned int num_lines = tetrahedron_tag().boundary_element_count( line_tag() );
        ...
        double diag58 = viennagrid::norm( viennagrid::get_point(mesh, vertices[5]) - viennagrid::get_point(mesh, vertices[8]) );
        double diag67 = viennagrid::norm( viennagrid::get_point(mesh, vertices[6]) - viennagrid::get_point(mesh, vertices[7]) );
        double diag49 = viennagrid::norm( viennagrid::get_point(mesh, vertices[4]) - viennagrid::get_point(mesh, vertices[9]) );
