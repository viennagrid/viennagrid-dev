...
//
    ...
    typename viennagrid::result_of::coord<PointT1>::type signed_spanned_volume_impl(PointT1 const & p1,
                                                                                    PointT2 const & p2)
    {
...
//   }
  ...
  {
    return detail::signed_spanned_volume_impl(p1, p2);
  }
