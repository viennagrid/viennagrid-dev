...
void test(std::string & infile, std::string & outfile)
{
  ...
  typedef typename viennagrid::result_of::line_range<MeshT>::type           EdgeContainer;
  typedef typename viennagrid::result_of::iterator<EdgeContainer>::type          EdgeIterator;

  typedef typename viennagrid::result_of::facet_range<MeshT>::type   FacetContainer;
  ...
  my_vtk_writer(mesh, outfile + ".vtu");
  my_vtk_writer(refined_mesh, outfile + "_refined.vtu");
  my_vtk_writer(double_refined_mesh, outfile + "_double_refined.vtu");
