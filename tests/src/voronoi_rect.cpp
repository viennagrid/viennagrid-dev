...
void setup_domain(DomainType & domain)
{
  ...
  VertexHandleType vh1 = viennagrid::make_vertex( domain, PointType(2, 0) );
  VertexHandleType vh2 = viennagrid::make_vertex( domain, PointType(1, 1) );
  VertexHandleType vh3 = viennagrid::make_vertex( domain, PointType(0, 2) );
  VertexHandleType vh4 = viennagrid::make_vertex( domain, PointType(-1, 1) );
  VertexHandleType vh5 = viennagrid::make_vertex( domain, PointType(-2, 0) );
  VertexHandleType vh6 = viennagrid::make_vertex( domain, PointType(-1, -1) );
  VertexHandleType vh7 = viennagrid::make_vertex( domain, PointType(0, -2) );
  VertexHandleType vh8 = viennagrid::make_vertex( domain, PointType(1, -1) );
  
  //
  // Step 2: Set up cells:
  //
  
  viennagrid::make_quadrilateral( domain, vh0, vh8, vh2, vh1 );
  viennagrid::make_quadrilateral( domain, vh0, vh2, vh4, vh3 );
  viennagrid::make_quadrilateral( domain, vh0, vh4, vh6, vh5 );
  viennagrid::make_quadrilateral( domain, vh0, vh6, vh8, vh7 );
}
...
int main(int argc, char *argv[])
{
  ...
  my_vtk_writer(domain, "voronoi_rect");
