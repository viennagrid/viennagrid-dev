...
//         std::cout << "Recalculating co-boundary" << std::endl;
    ...
    template<typename element_type_or_tag, typename coboundary_type_or_tag, typename coboundary_accessor_type, typename A, typename B, typename C, typename element_or_handle_type>
    viennagrid::storage::container_range_wrapper<typename coboundary_accessor_type::value_type> coboundary_elements(domain_t<A,B,C> & domain, coboundary_accessor_type accessor, element_or_handle_type & hendl)
    {
    ...
    template<typename element_type_or_tag, typename coboundary_type_or_tag, typename coboundary_accessor_type, typename A, typename B, typename C, typename element_or_handle_type>
    viennagrid::storage::container_range_wrapper<const typename coboundary_accessor_type::value_type> coboundary_elements(domain_t<A,B,C> const & domain, coboundary_accessor_type const accessor, element_or_handle_type const & hendl)
    {
        return coboundary_elements<element_type_or_tag, coboundary_type_or_tag>( accessor, viennagrid::dereference_handle(domain, hendl) );
    }
    ...
    template<typename element_type_or_tag, typename coboundary_type_or_tag, typename A, typename B, typename C, typename element_or_handle_type>
    typename result_of::coboundary_range<domain_t<A,B,C>, element_type_or_tag, coboundary_type_or_tag>::type coboundary_elements(domain_t<A,B,C> & domain, element_or_handle_type const & hendl)
    {
    ...
    template<typename element_type_or_tag, typename coboundary_type_or_tag, typename A, typename B, typename C, typename element_or_handle_type>
    typename result_of::const_coboundary_range<domain_t<A,B,C>, element_type_or_tag, coboundary_type_or_tag>::type coboundary_elements(domain_t<A,B,C> const & domain, element_or_handle_type const & hendl)
    {
        typedef domain_t<A,B,C> domain_type;
        typedef typename viennagrid::result_of::element_tag< element_type_or_tag >::type element_tag;
        typedef typename viennagrid::result_of::element_tag< coboundary_type_or_tag >::type coboundary_tag;
