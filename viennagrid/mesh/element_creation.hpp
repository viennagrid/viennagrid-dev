...
namespace viennagrid
{
  ...
  {
    typename viennagrid::result_of::vertex_handle<MeshOrSegmentHandleTypeT>::type vtx_handle = make_vertex(mesh_segment);
    viennagrid::point(mesh_segment, vtx_handle) = point;
    return vtx_handle;
  }
        ...
        typename result_of::point<MeshOrSegmentHandleTypeT>::type const & point)
  {
    ...
    typename result_of::vertex_handle<MeshOrSegmentHandleTypeT>::type ret = push_element<false, true>(mesh_segment, element ).first;
    viennagrid::point(mesh_segment, ret) = point;
        ...
        typename result_of::coord<MeshOrSegmentHandleTypeT>::type tolerance)
  {
    ...
    vertex_range_type vertices = viennagrid::elements(mesh_segment);
    for (vertex_range_iterator hit = vertices.begin(); hit != vertices.end(); ++hit)
    {
        if (viennagrid::norm_2( point - viennagrid::point(mesh_segment, *hit) ) < tolerance )
            return hit.handle();
    }

    return make_vertex(mesh_segment, point);
  }
  ...
  {
    return make_unique_vertex( mesh_segment, p, viennagrid::norm_2(p) / 1e6 );
  }
        ...
        VertexHandleT v0, VertexHandleT v1)
  {
    ...
    return make_element<viennagrid::line_tag>( mesh_segment, handles.begin(), handles.end() );
  }
        ...
        VertexHandleT v0, VertexHandleT v1)
  {
    ...
    return make_element<viennagrid::edge_tag>( mesh_segment, handles.begin(), handles.end() );
  }
        ...
        VertexHandleT v0, VertexHandleT v1, VertexHandleT v2)
  {
    ...
    return make_element<viennagrid::triangle_tag>( mesh_segment, handles.begin(), handles.end() );
  }
        ...
        VertexHandleT v0, VertexHandleT v1, VertexHandleT v2, VertexHandleT v3)
  {
    ...
    return make_element<viennagrid::quadrilateral_tag>( mesh_segment, handles.begin(), handles.end() );
  }
        ...
        PointIteratorT         hole_points_begin,     PointIteratorT          hole_points_end)
  {
    ...
    PLCType plc( inserter(mesh_segment).get_physical_container_collection() );
    ...
    PLCHandleType handle = viennagrid::push_element<true, true>(mesh_segment, plc ).first;

    PLCType & inserted_plc = viennagrid::dereference_handle(mesh_segment, handle);
        ...
        VertexHandleT v0, VertexHandleT v1, VertexHandleT v2, VertexHandleT v3)
  {
    ...
    return make_element<viennagrid::tetrahedron_tag>( mesh_segment, handles.begin(), handles.end() );
  }
        ...
        VertexHandleT v4, VertexHandleT v5, VertexHandleT v6, VertexHandleT v7)
  {
    ...
    return make_element<viennagrid::hexahedron_tag>( mesh_segment, handles.begin(), handles.end() );
  }
