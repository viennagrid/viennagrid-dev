...
#define VIENNAMETA_MAKE_TYPEMAP_1(K1, V1) ::viennameta::typemap::result_of::consistency< VIENNAMETA_MAKE_TYPEMAP_UNSAFE_1(K1, V1) >::type
#define VIENNAMETA_MAKE_TYPEMAP_2(K1, V1, K2, V2) ::viennameta::typemap::result_of::consistency< VIENNAMETA_MAKE_TYPEMAP_UNSAFE_2(K1, V1, K2, V2) >::type
#define VIENNAMETA_MAKE_TYPEMAP_3(K1, V1, K2, V2, K3, V3) ::viennameta::typemap::result_of::consistency< VIENNAMETA_MAKE_TYPEMAP_UNSAFE_3(K1, V1, K2, V2, K3, V3) >::type
#define VIENNAMETA_MAKE_TYPEMAP_4(K1, V1, K2, V2, K3, V3, K4, V4) ::viennameta::typemap::result_of::consistency< VIENNAMETA_MAKE_TYPEMAP_UNSAFE_4(K1, V1, K2, V2, K3, V3, K4, V4) >::type
