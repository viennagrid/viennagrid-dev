...
Again, it is recommended to define the macros in the source file containing \lstinline|main()| after the inclusion of the {\ViennaGrid} header files.
 ...
 \item \textbf{Method 2}: Instead of using the macros, one can instead manually adjust the meta-function \lstinline|bndcell_orientation|. The first macro of method 1 expands to
 \begin{lstlisting}
namespace viennagrid { namespace result_of {
  template <>
