...
void testNewDomain(std::string & infile, std::string & outfile)
{
  ...
  Domain domain;
  Domain const & const_domain = domain;
...
//  Segment & seg = domain.add();
  ...
  typedef viennagrid::result_of::ncell_container<Domain, 0>::type  ContainerT;
  typedef viennagrid::result_of::iterator<ContainerT>::type        ContainerTIterator;
  
  ContainerT elements = viennagrid::ncells<0>(domain);
  ...
  typedef viennagrid::result_of::const_ncell_container<Domain, 0>::type   ConstContainerT;
  typedef viennagrid::result_of::iterator<ConstContainerT>::type          ConstContainerTIterator;
  
  ConstContainerT const_elements = viennagrid::ncells<0>(const_domain);
  ...
  typedef viennagrid::result_of::ncell_container<Domain, Domain::config_type::cell_tag::topology_level>::type  CellContainerT;
  typedef viennagrid::result_of::iterator<CellContainerT>::type        CellContainerTIterator;
  
  CellContainerT cells = viennagrid::ncells<Domain::config_type::cell_tag::topology_level>(domain);
  for (CellContainerTIterator it = cells.begin();
       it != cells.end();
       ++it)
  {
    //std::cout << *it << std::endl; 
  ...
  typedef viennagrid::result_of::const_ncell_container<Domain, Domain::config_type::cell_tag::topology_level>::type   ConstCellContainerT;
  typedef viennagrid::result_of::iterator<ConstCellContainerT>::type          ConstCellContainerTIterator;
  
  ConstCellContainerT const_cells = viennagrid::ncells<Domain::config_type::cell_tag::topology_level>(const_domain);
  for (ConstCellContainerTIterator const_it = const_cells.begin();
       const_it != const_cells.end();
       ++const_it)
  {
    //std::cout << *it << std::endl; 
    const_it->print();
